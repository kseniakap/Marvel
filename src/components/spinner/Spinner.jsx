...
const Spinner = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" style={{margin: 'auto', background: "rgb(255, 255, 255)", display: "block", shapeRendering: "auto"}}width="100px" height="100px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
        <circle cx="84" cy="50" r="10" fill="#e63e39">
        ...
        <animate attributeName="fill" repeatCount="indefinite" dur="3.571428571428571s" calcMode="discrete" keyTimes="0;0.25;0.5;0.75;1" values="#e63e39;#c5d7df;#e6eeef;#e8dd6c;#e63e39" begin="0s"></animate>
        </circle><circle cx="16" cy="50" r="10" fill="#e63e39">
        ...
        </circle><circle cx="50" cy="50" r="10" fill="#e8dd6c">
        ...
        </circle><circle cx="84" cy="50" r="10" fill="#e6eeef">
        ...
        </circle><circle cx="16" cy="50" r="10" fill="#c5d7df">
